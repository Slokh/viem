...
| [`earn.depositNested`](/tempo/actions/earn.depositNested) | Deposits across nested inner and outer vaults |
| [`earn.depositShares`](/tempo/actions/earn.depositShares) | Deposits existing venue shares into an Earn vault |
| [`earn.getNestedAllocation`](/tempo/actions/earn.getNestedAllocation) | Gets the live inner and outer deposit split |
| [`earn.getOuterShareQuote`](/tempo/actions/earn.getOuterShareQuote) | Converts an inner share quote into an outer share quote |
| [`earn.getUnwrapQuote`](/tempo/actions/earn.getUnwrapQuote) | Gets the inner shares returned by unwrapping outer shares |
| [`earn.getNestedPosition`](/tempo/actions/earn.getNestedPosition) | Gets one unified nested Earn position |
| [`earn.getNestedRedeemQuote`](/tempo/actions/earn.getNestedRedeemQuote) | Gets per-vault and aggregate nested exit quotes |
...
| [`earn.unwrapNested`](/tempo/actions/earn.unwrapNested) | Converts outer shares directly into inner shares |
| [`earn.redeem`](/tempo/actions/earn.redeem) | Redeems an exact number of Earn shares |
| [`earn.redeemNested`](/tempo/actions/earn.redeemNested) | Redeems inner and outer shares atomically |
